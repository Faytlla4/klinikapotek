...
class Contextslte
{
	...
	protected static $templateContextMenu = "<li class='{parent_class}'>\n<a href='{url}' id='{id}' class='{current_class}' title='{title}'{extra}>\n<i class='nav-icon {icon}'></i>\n<p>\n{text}\n<i class='right fas fa-angle-left'></i>\n</p>\n</a>{content}</li>\n";
	protected static $templateMenu = "<li class='nav-item'>\n<a href='{url}' class='nav-link{extra}' title='{title}'>\n<i class='nav-icon far fa-circle'></i><p>{display}</p></a>\n</li>\n";
	protected static $templateSubMenu = "<li class='{submenu_class}'>\n<a href='{url}' class='nav-link'>\n<i class='nav-icon far fa-circle'></i>\n<p>\n{display}\n<i class='right fas fa-angle-left'></i>\n</p>\n</a>\n<ul class='{child_class}'>{view}</ul>\n</li>\n";

	protected static $templateContextImage = "<img src='{image}' alt='{title}' />";
	protected static $templateContextText = "{title}";
	protected static $templateContextMenuAnchorClass = 'nav-link';
	protected static $templateContextMenuExtra = " data-id='{dataId}_menu'";
	protected static $templateContextNavMobileClass = 'mobile_nav';

	/** @var string The class name to attach to the outer ul tag. */
	protected static $outer_class = 'nav nav-pills nav-sidebar flex-column';
	...
	protected static $child_class = 'nav nav-treeview';
	...
	/** @var array Sets the keys to the values. */
	...
	public static function render_menu($mode = 'text', $order_by = 'normal', $top_level_only = false, $benchmark = false)
	{
		...
		$menu = '';
		$contexts_icon = self::$ci->config->item('contexts_icon');
		foreach ($contexts as $context) {
			...
			if (self::$ci->auth->has_permission($viewPermission)
				...
				$menu .= str_replace(
					array('{parent_class}', '{url}', '{id}', '{current_class}', '{title}', '{extra}', '{icon}', '{text}', '{content}'),
					array(
						self::$parent_class . match_menu($context, true),
						site_url(self::$site_area . "/{$context}"),
						"tb_{$context}",
						($top_level_only ? '' : self::$templateContextMenuAnchorClass) . match_class($context, true),
						$title,
						str_replace('{dataId}', $context, self::$templateContextMenuExtra),
						$contexts_icon[$context],
						$navTitle,
	 ...
	 */
	public static function context_nav($context = null, $class = 'nav nav-treeview', $ignore_ul = false)
	{
		// Get a list of modules with a controller matching $context ('content', 'settings', 'reports', or 'developer').
