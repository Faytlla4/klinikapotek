...
class Content extends App_Controller
{
    ...
    public function detail($id) { $row = $this->transaksi_model->bukti($id); if (!$row) { show_404(); } Template::set('transaksi', $row); Template::set('toolbar_title', 'Bukti Transaksi'); Template::render(); }
}
