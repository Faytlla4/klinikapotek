        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="form-group <?php echo form_error('nama_spesialis') ? 'has-error' : ''; ?>">
                    ...
                    <input id="nama_spesialis" type="text" class="form-control" name="nama_spesialis" required value="<?php echo set_value('nama_spesialis', $spesialis->nama_spesialis ?? ''); ?>" />
                ...
                <div class="form-group">
                    ...
                    <select id="status" name="status" class="form-control select2">
                        <option value="AKTIF" <?php echo ($spesialis->status ?? '') === 'AKTIF' ? 'selected' : ''; ?>>AKTIF</option>
                        <option value="NONAKTIF" <?php echo ($spesialis->status ?? '') === 'NONAKTIF' ? 'selected' : ''; ?>>NONAKTIF</option>
                    </select>
                </div>
            </div>
