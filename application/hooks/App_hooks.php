...
class App_hooks
{
    ...
    public function checkSiteStatus()
    {
        ...
        // ponytail: tanpa tabel settings (skema apotek), anggap situs online
        $siteStatus = $this->ci->settings_lib->item('site.status');
        if ($siteStatus === false || $siteStatus === null || $siteStatus != 0) {
            return;
        }
