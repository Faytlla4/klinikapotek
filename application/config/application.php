 ...
 */
$config['site.default_user_timezone'] = 'UP7';
...
$config['enable_activity_logging'] = false; // ponytail: tabel activities tidak ada; audit memakai audit_logs via Audit_log_model
...
$config['template.adminlte_theme'] = 'adminlte';
